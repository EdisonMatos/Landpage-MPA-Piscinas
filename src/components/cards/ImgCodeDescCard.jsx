...
export default function ImgCodeDescCard(props) {
  ...
  return (
    <div className="w-full min-h-[360px] phone3:w-[46%] tablet1:w-[47%] tablet2:w-[30.5%] desktop1:w-[30.6%] desktop3:w-[31%] bg-white p-[15px] rounded-[10px] flex flex-col justify-between gap-[10px]">
